-- ******************************************************************************
-- * Student Time Tracking and Peer Review Database
-- *
-- * Written by Nikhil Giridharan, Tahoor Khalid, Arhum Khan, Farhat Kabir for CS 4485.
-- * NetID: jan200003, txk210035, axk210013, frk200000
-- *
-- * This database is designed to manage student time logs, team assignments, 
-- * course enrollments, and peer review submissions. It integrates various 
-- * tables to support functionalities such as tracking logged work, assigning 
-- * team numbers, and facilitating peer reviews with custom criteria and ratings.
-- ******************************************************************************
...
CREATE TABLE team_members (
    ...
    UNIQUE (course_id, team_number, student_id),
    FOREIGN KEY (course_id) REFERENCES courses(course_id),
    FOREIGN KEY (student_id) REFERENCES students(student_id)
);
